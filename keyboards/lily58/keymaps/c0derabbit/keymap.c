 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      | LGUI |LOWER | / Enter /       \Space \  |RAISE | LCtl |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, _______,  KC_LALT,  KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
                        _______, KC_LGUI, MO(_LOWER), KC_ENT,  KC_SPC, MO(_RAISE), KC_LCTL, _______ \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
[_LOWER] = LAYOUT( \
  _______, _______, _______, _______, _______, _______,                     KC_MRWD, KC_MPLY, KC_MFFD, KC_LPRN, KC_MINS, KC_EQL , \
...
[_RAISE] = LAYOUT( \
  _______, KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP, _______, _______, _______,                      _______, _______, _______, KC__VOLDOWN, KC__VOLUP, KC__MUTE, \
